module nc_cmp_realloc
    ...
    interface nc_diag_realloc
        module procedure nc_diag_realloc_byte, &
            ...
            nc_diag_realloc_logical, nc_diag_realloc_nc_cmpdn
    end interface nc_diag_realloc
    
    ! Variable dimensions storage
    type nc_diag_compress_dim_names
    ...
    end type nc_diag_compress_dim_names
    ...
    contains
        ...
        ! nc_diag_realloc_nc_cmpdn(arr, addl_num_entries)
        !   input:
        !     type(nc_diag_compress_dim_names), dimension(:)   :: arr
        !         array to reallocate
        !     integer(i_long), intent(in)    :: addl_num_entries
        !         additional number of elements to allocate to the
        !         specified array
        subroutine nc_diag_realloc_nc_cmpdn(arr, addl_num_entries)
            type(nc_diag_compress_dim_names), dimension(:), allocatable, intent(inout) :: arr
            integer(i_long),intent(in) :: addl_num_entries
            
            type(nc_diag_compress_dim_names), dimension(:), allocatable    :: tmp
            integer(i_long)                             :: new_size
            ...
            allocate(arr(new_size))
            arr = tmp
        end subroutine nc_diag_realloc_nc_cmpdn
