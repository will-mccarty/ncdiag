module ncdr_vars_fetch
    ...
    interface nc_diag_read_ret_var
        module procedure &
            nc_diag_read_id_ret_var_1d_byte, &
            nc_diag_read_id_ret_var_1d_short, &
            nc_diag_read_id_ret_var_1d_long, &
            nc_diag_read_id_ret_var_1d_float, &
            nc_diag_read_id_ret_var_1d_double, &
            nc_diag_read_id_ret_var_1d_string, &
            nc_diag_read_noid_ret_var_1d_byte, &
            nc_diag_read_noid_ret_var_1d_short, &
            nc_diag_read_noid_ret_var_1d_long, &
            nc_diag_read_noid_ret_var_1d_float, &
            nc_diag_read_noid_ret_var_1d_double, &
            nc_diag_read_noid_ret_var_1d_string, &
            nc_diag_read_id_ret_var_2d_byte, &
            nc_diag_read_id_ret_var_2d_short, &
            nc_diag_read_id_ret_var_2d_long, &
            nc_diag_read_id_ret_var_2d_float, &
            nc_diag_read_id_ret_var_2d_double, &
            nc_diag_read_id_ret_var_2d_string, &
            nc_diag_read_noid_ret_var_2d_byte, &
            nc_diag_read_noid_ret_var_2d_short, &
            nc_diag_read_noid_ret_var_2d_long, &
            nc_diag_read_noid_ret_var_2d_float, &
            nc_diag_read_noid_ret_var_2d_double, &
            nc_diag_read_noid_ret_var_2d_string
    end interface nc_diag_read_ret_var
    ...
    contains
        function nc_diag_read_id_ret_var_1d_byte(file_ncid, var_name) result(var_stor)
        ...
        end function nc_diag_read_id_ret_var_1d_byte
        
        function nc_diag_read_noid_ret_var_1d_byte(var_name) result(var_stor)
            character(len=*), intent(in)                :: var_name
            integer(i_byte), dimension(:), allocatable :: var_stor
            
            call ncdr_check_current_ncid
            
            var_stor = nc_diag_read_id_ret_var_1d_byte(current_ncid, var_name)
        end function nc_diag_read_noid_ret_var_1d_byte
        ...
        function nc_diag_read_id_ret_var_1d_short(file_ncid, var_name) result(var_stor)
            integer, intent(in)                        :: file_ncid
            character(len=*), intent(in)               :: var_name
            ...
            call check(nf90_get_var(file_ncid, var_index, &
                    ...
                    start = (/ 1 /), &
                    count = (/ ncdr_files(file_ind)%vars(var_index)%var_dim_sizes(1) /) ))
        end function nc_diag_read_id_ret_var_1d_short
        
        function nc_diag_read_noid_ret_var_1d_short(var_name) result(var_stor)
            character(len=*), intent(in)                :: var_name
            integer(i_short), dimension(:), allocatable :: var_stor
            
            call ncdr_check_current_ncid
            
            var_stor = nc_diag_read_id_ret_var_1d_short(current_ncid, var_name)
        end function nc_diag_read_noid_ret_var_1d_short
        ...
        subroutine nc_diag_read_noid_get_var_1d_short(var_name, var_stor)
            ...
            call nc_diag_read_id_get_var_1d_short(current_ncid, var_name, var_stor)
                ...
                function nc_diag_read_id_ret_var_1d_long(file_ncid, var_name) result(var_stor)
            integer, intent(in)                        :: file_ncid
            character(len=*), intent(in)               :: var_name
            ...
            call check(nf90_get_var(file_ncid, var_index, &
                    ...
                    start = (/ 1 /), &
                    count = (/ ncdr_files(file_ind)%vars(var_index)%var_dim_sizes(1) /) ))
        end function nc_diag_read_id_ret_var_1d_long
        
        function nc_diag_read_noid_ret_var_1d_long(var_name) result(var_stor)
            character(len=*), intent(in)                :: var_name
            integer(i_long), dimension(:), allocatable :: var_stor
            
            call ncdr_check_current_ncid
            
            var_stor = nc_diag_read_id_ret_var_1d_long(current_ncid, var_name)
        end function nc_diag_read_noid_ret_var_1d_long
        ...
        function nc_diag_read_id_ret_var_1d_float(file_ncid, var_name) result(var_stor)
            integer, intent(in)                        :: file_ncid
            character(len=*), intent(in)               :: var_name
            ...
            call check(nf90_get_var(file_ncid, var_index, &
                    ...
                    start = (/ 1 /), &
                    count = (/ ncdr_files(file_ind)%vars(var_index)%var_dim_sizes(1) /) ))
        end function nc_diag_read_id_ret_var_1d_float
        
        function nc_diag_read_noid_ret_var_1d_float(var_name) result(var_stor)
            character(len=*), intent(in)                :: var_name
            real(r_single), dimension(:), allocatable :: var_stor
            
            call ncdr_check_current_ncid
            
            var_stor = nc_diag_read_id_ret_var_1d_float(current_ncid, var_name)
        end function nc_diag_read_noid_ret_var_1d_float
        ...
        subroutine nc_diag_read_noid_get_var_1d_float(var_name, var_stor)
            ...
            call nc_diag_read_id_get_var_1d_float(current_ncid, var_name, var_stor)
                ...
                function nc_diag_read_id_ret_var_1d_double(file_ncid, var_name) result(var_stor)
            integer, intent(in)                        :: file_ncid
            character(len=*), intent(in)               :: var_name
            ...
            call check(nf90_get_var(file_ncid, var_index, &
                    ...
                    start = (/ 1 /), &
                    count = (/ ncdr_files(file_ind)%vars(var_index)%var_dim_sizes(1) /) ))
        end function nc_diag_read_id_ret_var_1d_double
        
        function nc_diag_read_noid_ret_var_1d_double(var_name) result(var_stor)
            character(len=*), intent(in)                :: var_name
            real(r_double), dimension(:), allocatable :: var_stor
            
            call ncdr_check_current_ncid
            
            var_stor = nc_diag_read_id_ret_var_1d_double(current_ncid, var_name)
        end function nc_diag_read_noid_ret_var_1d_double
        ...
        subroutine nc_diag_read_noid_get_var_1d_double(var_name, var_stor)
            ...
            call nc_diag_read_id_get_var_1d_double(current_ncid, var_name, var_stor)
                ...
                function nc_diag_read_id_ret_var_1d_string(file_ncid, var_name) result(var_stor)
            integer, intent(in)                        :: file_ncid
            character(len=*), intent(in)               :: var_name
            ...
            call check(nf90_get_var(file_ncid, var_index, &
                    ...
                    count = (/ ncdr_files(file_ind)%vars(var_index)%var_dim_sizes(1), &
                        ncdr_files(file_ind)%vars(var_index)%var_dim_sizes(2) /) ))
        end function nc_diag_read_id_ret_var_1d_string
        
        function nc_diag_read_noid_ret_var_1d_string(var_name) result(var_stor)
            character(len=*), intent(in)                :: var_name
            character(len=:), dimension(:), allocatable :: var_stor
            
            call ncdr_check_current_ncid
            
            var_stor = nc_diag_read_id_ret_var_1d_string(current_ncid, var_name)
        end function nc_diag_read_noid_ret_var_1d_string
        ...
        subroutine nc_diag_read_noid_get_var_1d_string(var_name, var_stor)
            ...
            call nc_diag_read_id_get_var_1d_string(current_ncid, var_name, var_stor)
                ...
                function nc_diag_read_id_ret_var_2d_byte(file_ncid, var_name) result(var_stor)
            integer, intent(in)                        :: file_ncid
            character(len=*), intent(in)               :: var_name
            ...
            call check(nf90_get_var(file_ncid, var_index, &
                    ...
                    start = (/ 1 /), &
                    count = (/ ncdr_files(file_ind)%vars(var_index)%var_dim_sizes(1) /) ))
        end function nc_diag_read_id_ret_var_2d_byte
        
        function nc_diag_read_noid_ret_var_2d_byte(var_name) result(var_stor)
            character(len=*), intent(in)                :: var_name
            integer(i_byte),dimension(:,:),allocatable :: var_stor
            
            call ncdr_check_current_ncid
            
            var_stor = nc_diag_read_id_ret_var_2d_byte(current_ncid, var_name)
        end function nc_diag_read_noid_ret_var_2d_byte
        ...
        subroutine nc_diag_read_noid_get_var_2d_byte(var_name, var_stor)
            ...
            call nc_diag_read_id_get_var_2d_byte(current_ncid, var_name, var_stor)
                ...
                function nc_diag_read_id_ret_var_2d_short(file_ncid, var_name) result(var_stor)
            integer, intent(in)                        :: file_ncid
            character(len=*), intent(in)               :: var_name
            ...
            call check(nf90_get_var(file_ncid, var_index, &
                    ...
                    start = (/ 1 /), &
                    count = (/ ncdr_files(file_ind)%vars(var_index)%var_dim_sizes(1) /) ))
        end function nc_diag_read_id_ret_var_2d_short
        
        function nc_diag_read_noid_ret_var_2d_short(var_name) result(var_stor)
            character(len=*), intent(in)                :: var_name
            integer(i_short),dimension(:,:),allocatable :: var_stor
            
            call ncdr_check_current_ncid
            
            var_stor = nc_diag_read_id_ret_var_2d_short(current_ncid, var_name)
        end function nc_diag_read_noid_ret_var_2d_short
        ...
        subroutine nc_diag_read_noid_get_var_2d_short(var_name, var_stor)
            ...
            call nc_diag_read_id_get_var_2d_short(current_ncid, var_name, var_stor)
                ...
                function nc_diag_read_id_ret_var_2d_long(file_ncid, var_name) result(var_stor)
            integer, intent(in)                        :: file_ncid
            character(len=*), intent(in)               :: var_name
            ...
            call check(nf90_get_var(file_ncid, var_index, &
                    ...
                    start = (/ 1 /), &
                    count = (/ ncdr_files(file_ind)%vars(var_index)%var_dim_sizes(1) /) ))
        end function nc_diag_read_id_ret_var_2d_long
        
        function nc_diag_read_noid_ret_var_2d_long(var_name) result(var_stor)
            character(len=*), intent(in)                :: var_name
            integer(i_long),dimension(:,:),allocatable :: var_stor
            
            call ncdr_check_current_ncid
            
            var_stor = nc_diag_read_id_ret_var_2d_long(current_ncid, var_name)
        end function nc_diag_read_noid_ret_var_2d_long
        ...
        subroutine nc_diag_read_noid_get_var_2d_long(var_name, var_stor)
            ...
            call nc_diag_read_id_get_var_2d_long(current_ncid, var_name, var_stor)
                ...
                function nc_diag_read_id_ret_var_2d_float(file_ncid, var_name) result(var_stor)
            integer, intent(in)                        :: file_ncid
            character(len=*), intent(in)               :: var_name
            ...
            call check(nf90_get_var(file_ncid, var_index, &
                    ...
                    start = (/ 1 /), &
                    count = (/ ncdr_files(file_ind)%vars(var_index)%var_dim_sizes(1) /) ))
        end function nc_diag_read_id_ret_var_2d_float
        
        function nc_diag_read_noid_ret_var_2d_float(var_name) result(var_stor)
            character(len=*), intent(in)                :: var_name
            real(r_single),dimension(:,:),allocatable :: var_stor
            
            call ncdr_check_current_ncid
            
            var_stor = nc_diag_read_id_ret_var_2d_float(current_ncid, var_name)
        end function nc_diag_read_noid_ret_var_2d_float
        ...
        function nc_diag_read_id_ret_var_2d_double(file_ncid, var_name) result(var_stor)
            integer, intent(in)                        :: file_ncid
            character(len=*), intent(in)               :: var_name
            ...
            call check(nf90_get_var(file_ncid, var_index, &
                    ...
                    start = (/ 1 /), &
                    count = (/ ncdr_files(file_ind)%vars(var_index)%var_dim_sizes(1) /) ))
        end function nc_diag_read_id_ret_var_2d_double
        
        function nc_diag_read_noid_ret_var_2d_double(var_name) result(var_stor)
            character(len=*), intent(in)                :: var_name
            real(r_double),dimension(:,:),allocatable :: var_stor
            
            call ncdr_check_current_ncid
            
            var_stor = nc_diag_read_id_ret_var_2d_double(current_ncid, var_name)
        end function nc_diag_read_noid_ret_var_2d_double
        ...
        function nc_diag_read_id_ret_var_2d_string(file_ncid, var_name) result(var_stor)
            integer, intent(in)                        :: file_ncid
            character(len=*), intent(in)               :: var_name
            ...
            call check(nf90_get_var(file_ncid, var_index, &
                    ...
                    count = (/ ncdr_files(file_ind)%vars(var_index)%var_dim_sizes(1), &
                        ncdr_files(file_ind)%vars(var_index)%var_dim_sizes(2), &
                        ncdr_files(file_ind)%vars(var_index)%var_dim_sizes(3) /) ))
        end function nc_diag_read_id_ret_var_2d_string
        
        function nc_diag_read_noid_ret_var_2d_string(var_name) result(var_stor)
            character(len=*), intent(in)                :: var_name
            character(len=:),dimension(:,:),allocatable :: var_stor
            
            call ncdr_check_current_ncid
            
            var_stor = nc_diag_read_id_ret_var_2d_string(current_ncid, var_name)
        end function nc_diag_read_noid_ret_var_2d_string
