program test_nclayer_allcov
    ...
    character(len=10), dimension(5) :: string_arr
    ...
    call nc_diag_chaninfo_prealloc_vars(1)
    call nc_diag_chaninfo_prealloc_vars_storage(NLAYER_BYTE, 1)
    ...
    call nc_diag_write
end program test_nclayer_allcov
